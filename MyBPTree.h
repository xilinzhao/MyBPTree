...
*/
template<typename KeyT, typename ValT>
inline int MyBPTree<KeyT, ValT>::keyIndex(Node<KeyT, ValT> *_node, KeyT _key){
    int loc = -1;
...
*/
template<typename KeyT, typename ValT>
inline std::pair<Node<KeyT, ValT>*, int> MyBPTree<KeyT, ValT>::keyIndexInLeaf(KeyT _key){
    if(root == nullptr){
...
*/
template<typename KeyT, typename ValT>
Node<KeyT, ValT>* MyBPTree<KeyT, ValT>::splitLeaf(Node<KeyT, ValT>* _leaf){
...
*/
template<typename KeyT, typename ValT>
std::pair<Node<KeyT, ValT>*, KeyT> MyBPTree<KeyT, ValT>::splitNode(Node<KeyT, ValT>* _node){
...
*/
template<typename KeyT, typename ValT>
void MyBPTree<KeyT, ValT>::createIndex(Node<KeyT, ValT>* _new_node, KeyT _index){
...
template<typename KeyT, typename ValT>
MyBPTree<KeyT, ValT>::MyBPTree() : root(nullptr) {}
...
template<typename KeyT, typename ValT>
void MyBPTree<KeyT, ValT>::display(){
    if(root == nullptr){
